...
func newControllerButtons() map[string]*controllerButton {
	return map[string]*controllerButton{
		...
		"trigger:left":   {code: sdl.CONTROLLER_AXIS_TRIGGERLEFT, isAxis: true, Button: Button{deadZone: 2000}},
		"trigger:right":  {code: sdl.CONTROLLER_AXIS_TRIGGERRIGHT, isAxis: true, Button: Button{deadZone: 2000}},
